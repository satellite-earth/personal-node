...
# Satellite Personal Node build repo

This repo is used to build and publish versions of [@satellite-earth/personal-node](https://github.com/satellite-earth/packages/tree/master/apps/personal-node)
